...
| 9 | MED | No decision exists for schema migrations/backfills (tooling, `schemaVersion`, tenant-batched backfills under `SystemScope.run`) — improvising this post-launch is painful. | **PLANNED** — ADR-0010; scope and required decisions in `docs/plans/adr-0010-schema-migrations-10-07-2026-plan.md`. Must be Accepted before first production deploy. |
