 ...
 * shape (apps/api/src/documents/storage/storage-provider.ts) — one small
 * interface, swappable concrete adapter, no shared libs/notifications
 * package needed for a single method.
 */
